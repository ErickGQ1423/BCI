/*
 * BCI_Display.ino — ST7789 240x240
 *
...
// Control de motores — no-blocking con millis()
void updateMotors() {
...
void loop() {
  ...
  digitalWrite(
    FLEX_PINKY_PIN,
    phase == FEEDBACK_MI ? HIGH : LOW
  );
  
  digitalWrite(
    FLEX_THUMB_PIN,
    phase == FEEDBACK_REST ? HIGH : LOW
  );
}
